...
class ViewFriendsFragment : Fragment(), FriendsAdapter.OnFriendListener {
    ...
    override fun onCreateView(
        ...
        // STEP 10: call the adapter's setData method when the friends list changes
//        val friendAdapter = FriendsAdapter(listOf(), this)
    ...
    override fun onFriendClick(position: Int) {
        ...
        builder.setItems(options) { _, optionId ->
            //STEP 11: make sure our onFriendClick method sends the correct friend from our view model to dispatch action
            TODO("connect dispatch action")
